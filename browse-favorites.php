	...
	?>
      ...
      <div class="col-md-9">  <!-- start main content column -->
         <ol class="breadcrumb">
           ...
           <li><a href="#" class="active">Browse Favorites</a></li>
         </ol>   
         
         <div class="jumbotron" id="postJumbo">
           <h1>Favorites</h1>
           <p>Check out your favorites...</p>
           <p><a href="remove-favorites.php" class="btn btn-warning btn-lg">Remove All Favorites &raquo;</a></p>
         </div>        
